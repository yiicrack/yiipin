...
<div id="wrapper">
	...
	<h3 class="i_suc f24">密码重设邮件发送成功！请稍后访问您的邮箱，按照邮件提示操作！</h3>
	<div class="clear"></div>
	<p class="l22 mb30 f14n">
	一封包含密码重设链接的邮件已经发送到你的邮箱<span class="red"><?php echo $email ?></span><br />
	点击邮件里的链接即可重设密码，快去查收邮件吧！
	</p>
	<?php if($mail_index):?>
	...
	<div class="noEmail">
		...
		<ul class="mt14 l22">
			<li>· 可以尝试到垃圾邮件里找找看</li>
			<li>· 邮箱地址写错了？很抱歉，你需要<a class="red" href="<?php echo $this->createUrl('/site/forgetpassword'); ?>">重试找回密码</a></li>
		</ul>
	</div>
</div>
	</div>
