<?php foreach($shares as $index=>$data):?>
    ...
    <div class="new_poster">
      <div class="np_pic">
        ...
        <div class="like_merge" style="display: none;"> 
	        <a href="javascript:void(0)" class="hw46 right_f poster_comment js-comment"><span class="plm_bgr"></span><em class="lm_comm">&nbsp;</em>评论</a> 
      ...
      <div class="np_share"> 
        ...
        <p class="ml40_f"> <a target="_blank" href="<?php echo $data->user_id ?>" class="fb_f"><?php echo $data->username ?></a> 
        <span>分享到</span>
      ...
      <div class="poster_cmt none_f"> 
      	<a target="_blank" user_id="0" href="/person/u/0" class="avatar32_f"><img src="<?php echo THEME_DIR ?>/images/0.gif"></a>
        <div class="cmt_r">
