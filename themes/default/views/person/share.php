...
$(document).ready(function(){
	...
	Yiipin.masonry({
		url: '<?php echo $this->createUrl('/person/getShares', array('user_id'=>$this->user->id)); ?>', 
    ...
    <div id="content_fluid" style="margin:0 auto;" class="person_index">
              ...
              <div class="per_tabs box_inset pr overflow">
               <?php extract($this->getStats());?>
                <ul class="tabs_bar box_inset f20 fb">
                  ...
                  <li class="red"><a href="<?php echo $this->createUrl('/person/share', array('user_id'=>$this->user->id)); ?>"><?php echo $shareCount ?>分享</a></li>
      ...
      <div id="wall" class="clearfix masonry">
        ...
        <div class="first_frame">
            <?php $this->actionGetShares($this->user->id, 0, $_GET['page'] ? $_GET['page'] : 1);?>
        </div>
        </div>
      <div class="clear"></div>
