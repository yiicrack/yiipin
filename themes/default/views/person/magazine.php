...
$(document).ready(function(){
	...
	Yiipin.masonry({
		url: '<?php echo $this->createUrl('/person/getMagazines', array('user_id'=>$this->user->id)); ?>', 
...
<div id="main" class="container_12">
    ...
    <div id="content_fluid" style="margin:0 auto;">
    <div class="corner_nav">
          <div class="per_tabs box_inset pr overflow">
            ...
            <ul class="tabs_bar box_inset f20 fb">
              ...
              <li  class="red"><a href="<?php echo $this->createUrl('/person/magazine', array('user_id'=>$this->user->id)); ?>" ><?php echo $groupCount ?>杂志</a></li>
    ...
    <div class="spinner none topSpinner"></div>
      <div id="wall" class="clearfix masonry">
        ...
        <div class="first_frame">
            <?php $this->actionGetMagazines($this->user->id, 0, $_GET['page'] ? $_GET['page'] : 1);?>
        </div>
    </div>
      <div class="clear"></div>
