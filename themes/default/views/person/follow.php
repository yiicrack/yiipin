...
$(document).ready(function(){
	...
	Yiipin.masonry({
		url: '<?php echo $this->createUrl('/person/getFollows', array('user_id'=>$this->user->id)); ?>', 
...
<div id="main" class="container_12">
    ...
    <div class="corner_nav">
        ...
        <ul class="tabs_bar box_inset f20 fb">
          ...
          <li  class="red"><a href="<?php echo $this->createUrl('/person/follow', array('user_id'=>$this->user->id)); ?>"><?php echo $followCount ?>关注的杂志</a></li>
        </ul>
        <div class="clear"></div>
      </div>
    </div>
    ...
    <div id="content_fluid" style="margin:0 auto;">
      <div id="wall" class="clearfix masonry" >
        ...
        <div class="first_frame">
            <?php $this->actionGetFollows($this->user->id, 0, $_GET['page'] ? $_GET['page'] : 1);?>
        </div>
    </div>
      <div class="clear"></div>
