<?php 
$this->pageTitle = ($this->user->id == Yii::app()->user->id ? '我':$this->user->username)."关注的人";
$this->keywords = '';
	...
	<div style="_overflow: hidden;" class="grid_9">
		<div class="box_shadow p13 mt14">
			<div id="ur_follow_warp">
				<div id="follow_name"><?php echo $this->user->id == Yii::app()->user->id ? '我':$this->user->username;?>关注的人 (<?php echo $this->user->follow_count ; ?>)</div>
