...
<table class="search-form" width="100%">
    ...
    <table>
		<tr>
            ...
            <td style="text-align:right;vertical-align:middle;"><?php echo $form->label($model,'sortnum'); ?></td>
            <td><?php echo $form->textField($model,'sortnum', array('size'=>10)); ?></td>
            <td style="text-align:right;vertical-align:middle;"><?php echo $form->label($model,'group_count'); ?></td>
            <td><?php echo $form->textField($model,'group_count', array('size'=>10)); ?></td>
            <td>
