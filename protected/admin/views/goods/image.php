...
<table class="search-form" width="100%">
    ...
    <table>
		<tr>
            ...
            <td><?php $this->widget('backend.extensions.GoodsCategoryDropDownList', array('model'=>$model, 'attribute'=>'category_id', 'group'=>false, 'level'=>2 ,'htmlOptions'=>array('empty'=>'请选择'))); ?></td>
...
//		'user_id',	
        ...
        //array('name'=>'name', 'headerHtmlOptions' => array('style'=>'width:300px')),
