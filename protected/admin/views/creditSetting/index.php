<?php
$label = CActiveRecord::model('CreditSetting')->modelName;
...
<table class="search-form" width="100%">
    ...
    <table>
		<tr>
            ...
            <td style="text-align:right;vertical-align:middle;"><?php echo $form->label($model,'alias'); ?></td>
            <td> <?php echo $form->textField($model,'score', array('size'=>10)); ?></td>
            <td>
