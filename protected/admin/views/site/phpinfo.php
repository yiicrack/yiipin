...
#top { width:720px; }
#t1 { height:6px; border-bottom:1px solid #666666; }
...
#mainBG { width:720px; }	
#main {  width:680px; padding:5px 20px 0px 20px; border-top:1px solid #ffffff; border-bottom:1px solid #9e9e9e; float:left;}
...
#m4 th,#m4 td { padding:3px; border-bottom:none; text-align:center; }
...
============================================================== -->
			...
			<table>
				...
				<tr>
					<td>PHP信息&nbsp;PHPINFO</td>
					<td><?=(false!==eregi("phpinfo",$disFuns))?NO:"<a href='/admin.php?r=site/phpinfo&act=phpinfo' target='_blank' class='static'>PHPINFO</a>"?></td>
				</tr>
			</table>
			<!-- ============================================================= 
PHP组件支持 
