<?php
$label = CActiveRecord::model('GoodsCategory')->modelName;
...
<table class="search-form" width="100%">
    ...
    <table>
		<tr>
            ...
            <td style="text-align:right;vertical-align:middle;"><?php echo $form->label($model,'parent_id'); ?></td>
            <td><?php echo $form->textField($model,'parent_id', array('size'=>10)); ?></td>
            <td style="text-align:right;vertical-align:middle;"><?php echo $form->label($model,'name'); ?></td>
            <td><?php echo $form->textField($model,'name',array('size'=>20,'maxlength'=>256)); ?></td>
            <td>
	...
	'columns'=>array(
		...
		array(
			...
			'buttons'=>array(
				'tags'=>array(
					'label'=>'标签',
					'url'=>'Yii::app()->controller->createUrl("tags",array("id"=>$data->primaryKey))',
				),
			),
		),
	),
